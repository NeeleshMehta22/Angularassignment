...
var getUsers = function (req, res) {
    pool.query('SELECT * ,(SELECT cname FROM schema1.customer as customer where u.id=user_id) FROM userdata as u order by id', function (error, results) {
        if (error) {
            throw error;
        }
...
// ,(SELECT cname FROM customer where SCHEMA1.customer.user_id = u.id)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                console.log(id);
                return [4 /*yield*/, pool.query('DELETE FROM SCHEMA1.customer WHERE SCHEMA1.customer.user_id = $1', [id], function (error, results) {
                        // if (error) {
                        //   console.log(error);
                        //   throw error
                        // }
